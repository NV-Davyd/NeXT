...
<p align="center"><a href="https://github.com/NV-Davyd/NeXT/releases/latest/download/NeXT-1.2.0.zip"><strong>Download NeXT 1.2.0</strong></a> · <a href="https://next-mod.pages.dev">Account</a></p>
...
**Already using BepInEx?** Copy only the mod folder from `BepInEx/plugins` into your existing `BepInEx/plugins` folder.
